...
<%
    ...
    if (rol.equalsIgnoreCase("Bodega-Jefe")) {
        sidebar = "<!-- Inicio sub menu de home -->\n"
                ...
                + "                    <span id=\"dispatch\">Despachos</span>\n"
                + "                </a>\n"
                ...
                + "                    <span id=\"deliveries\">Entregas</span>\n"
                + "                </a>\n"
                + "                <ul class=\"sub text-center\">\n"
                ...
                + "                    <span id=\"messenger\">Mensajeros</span>\n"
                + "                </a>\n"
                + "                <ul class=\"sub text-center\">\n"
