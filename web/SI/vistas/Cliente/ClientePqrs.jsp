            ...
            <aside>
                <div id="sidebar" class="nav-collapse menumio">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <h5 class="centered nombreUsuario">Administrador</h5>
    ...
    <script>
        ...
        $(function () {
            $('#btncrearproducto').click(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $('#textoModalResult').text("Producto creado exitosamente!");
            ...
            $(document).on('click', 'button.btnUpdate', function (e) {
              ...
              var idProductoM =fila.find('td:eq(0)').text();
              var nombreM =fila.find('td:eq(1)').text();
              var telajeM =fila.find('td:eq(2)').text();              
              var ubicacionM =fila.find('td:eq(3)').text();
              var precioM =fila.find('td:eq(4)').text();
              var stockM =fila.find('td:eq(5)').text();
              
              $('#idProductoA').val(idProductoM);
                $('#nombreProductoA').val(nombreM);
                $('#telajeProductoA').val(telajeM);
                $('#ubicacionBodegaA').val(ubicacionM);
                $('#precioMCA').val(precioM);
                $('#stockA').val(stockM);
