    ...
    <body>
        <section id="container">
            ...
            <header class="header black-bg">
                ...
                <!--logo inicio-->
                <a href="BodegaHome.jsp" class="logo"><b>SYCOM<span>T3</span></b></a>
                <!--logo fin-->
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub text-center">
                                ...
                                <li><a id="suppliersHistoric" class="sub-a active" href="MensajeroEntregasRealizadas.jsp">Realizadas</a></li>
                            </ul>
                        </li>
